...
quantitative approaches to the ancient economy over long periods, including lead, silver and 
copper levels in sediment and ice cores.]
...
direct index of the overall level of maritime economic activity in the Mediterranean.^[There are
genuine complications here: e.g. the type of cargo makes a very big difference in the likelihood of
an ancient shipwreck being located, and the change in storage containers from amphorae to barrels by
the Medieval period may obscure many sites of Medieval wrecks -- there is simply no mound of
amphorae to be found. See @robinson_developments_2011, @rice_shipwreck_2016, 1661-68.]
...
twenty years?^[See @robinson_developments_2011 for a similar re-assessment based on more recent 
data.]
