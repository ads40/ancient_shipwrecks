...
1. List the set of countries where the shipwrecks are found. 
...
1. Plot the shipwrecks on a map (use ggplot and rnaturalearth for the maps).
...
ggplot(data = world) +
  ...
  # add direction and scale annotations
